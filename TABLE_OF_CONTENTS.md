...
|---|---|---|
| It's my Tuesday/Thursday-morning routine | `python scripts/run_scrapers.py && python scripts/score_jobs.py` | Auto-scrapes the named-co list, filters, scores survivors, **appends rows to the Google Sheet** (Phase C). ~5–10 min + ~$1 per run |
